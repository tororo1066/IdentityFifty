...
class DashUltraSpeed :AbstractSurvivorTalent("dash_ultra_speed",5,WoundedCowUp::class.java) {
    ...
    override fun onStart(p: Player) {
        val dashUltraSpeed = SItem(Material.STICK).setDisplayName(KeyMap.translate("dash_ultra_speed")).setCustomModelData(3344)
                .addLore("dash_ultra_speed_lore_1")

        val dashUltraSpeedItem = IdentityFifty.interactManager.createSInteractItem(dashUltraSpeed, true).setInteractEvent{ _, _ ->
            noDamage = true
